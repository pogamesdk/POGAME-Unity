...
public class POSDK : MonoBehaviour
{
    public static POSDK Instance;
    ...
    void Init()
    {
        ...
        {
            Debug.LogWarning("POSDK initialization failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    internal void ShowAd()
    {
        ...
        {
            Debug.LogWarning("POSDK ShowAd failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    ...
    internal void PreloadRewardedAd()
    {
        ...
        {
            Debug.LogWarning("POSDK Preload failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    ...
    internal void SendEvent(string options)
    {
        ...
        {
            Debug.LogWarning("POSDK SendEvent failed. Make sure you are running a WebGL build in a browser:" + e.Message);
        }
    }
    /// <summary>
